...
class AlienInvasion:
    ...
    def __init__(self):
        ...
        # Create an instance of gamestats to store game stats and scoreboard to display score
    ...
    def _check_play_button(self, mouse_pos):
        ...
        if button_clicked and not self.stats.game_active:
            ...
            # destroy remaining aliens and bullets
            self.aliens.empty()
            self.bullets.empty()
    ...
    def _update_aliens(self):
        ...
        # detect aliens reaching the bottom
    ...
    def _ship_hit(self):
        """Respond to ship colliding with alien"""
        if self.stats.ships_left > 0:
            ...
            # pause for user to get set up for next life
            sleep(1)
        else:
